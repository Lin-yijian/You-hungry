package com.yh.aspect;


import com.yh.annotation.AutoFill;
import com.yh.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.yh.mapper.*.*(..)) && @annotation(com.yh.annotation.AutoFill)")
    public void autoFillPointCut(){}


    /**
     * 通知，只是一个前置通知，因为要在使用sql语句之前实施正确的通知
     *
     */
